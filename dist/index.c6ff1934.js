/*!
  ...
  */ !function(t, e) {
    ...
    const H = {
        ...
        off (t, e, i, n) {
            ...
            c && Object.keys(l).forEach((i)=>{
                !function(t, e, i, n) {
                    ...
                    Object.keys(s).forEach((o)=>{
                        if (o.includes(n)) {
                            const n1 = s[o];
                            P(t, e, i, n1.originalHandler, n1.delegationSelector);
                        }
                    });
                }(t, l, i, e.slice(1));
            });
            ...
            Object.keys(d).forEach((i)=>{
                ...
                if (!a || e.includes(n)) {
                    const e1 = d[i];
                    P(t, l, r, e1.originalHandler, e1.delegationSelector);
                }
            });
        },
        trigger (t, e, i) {
    ...
    H.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Q.dataApiClickHandler), H.on(window, "load.bs.carousel.data-api", ()=>{
        ...
        for(let t1 = 0, i = e.length; t1 < i; t1++)Q.carouselInterface(e[t1], w.get(e[t1], "bs.carousel"));
    }), b(Q);
    const G = {
        toggle: !0,
        parent: ""
    ...
    class J extends R {
        ...
        show() {
            ...
            if (e) {
                ...
                if (i = t1 ? w.get(t1, "bs.collapse") : null, i && i._isTransitioning) return;
            }
    ...
    class we extends R {
        ...
        show() {
            ...
            if (!H.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                if (this._inNavbar) U.setDataAttribute(this._menu, "popper", "none");
                    ...
                    "parent" === this._config.reference ? e1 = t : a(this._config.reference) ? e1 = l(this._config.reference) : "object" == typeof this._config.reference && (e1 = this._config.reference);
                    const i = this._getPopperConfig(), n = i.modifiers.find((t)=>"applyStyles" === t.name && !1 === t.enabled);
                    this._popper = de(e1, this._menu, i), n && U.setDataAttribute(this._menu, "popper", "static");
                }
        ...
        static clearMenus(e) {
            ...
            for(let t1 = 0, n = i.length; t1 < n; t1++){
                const n1 = w.get(i[t1], "bs.dropdown");
    ...
    function qe(t, e, i) {
        ...
        for(let t1 = 0, i1 = o.length; t1 < i1; t1++){
            ...
            r.forEach((t)=>{
                We(t, a) || i2.removeAttribute(t.nodeName);
            });
        }
